...
import torch
from swastikA.preprocessing.schemas import State
from swastikA.svg_converter import TS_ImageToSVGStringBW_Potracer
...
class SVGConverterNode:
    ...
    def __call__(self, state: State) -> State:
        ...
        try:
            ...
            input_path = Path(state.recreated_kolam_image_path)
            output_filename = f"{input_path.stem}.svg"  # Use input filename with .svg extension
